...
class FormBuilderValidators {
  ...
  static FormFieldValidator<T> required<T>(
    ...
    return (T valueCandidate) {
      if (valueCandidate == null ||
        ...
        return errorText ?? FormBuilderLocalizations.of(context).requiredErrorText;
      }
      return null;
    };
  }
  ...
  static FormFieldValidator<T> equal<T>(
    ...
    String errorText,
      ...
      (valueCandidate) => valueCandidate != value ? errorText ?? FormBuilderLocalizations.of(context).equalErrorText(value) : null;
  ...
  static FormFieldValidator<T> notEqual<T>(
    ...
    String errorText,
      ...
      (valueCandidate) => valueCandidate == value ? errorText ?? FormBuilderLocalizations.of(context).notEqualErrorText(value) : null;
    ...
    return (T valueCandidate) {
      if (valueCandidate != null) {
        ...
        if (number != null && (inclusive ? number < min : number <= min)) {
          return errorText ?? FormBuilderLocalizations.of(context).minErrorText(min);
        }
      }
      return null;
    };
    ...
    return (T valueCandidate) {
      if (valueCandidate != null) {
        ...
        if (number != null && (inclusive ? number > max : number >= max)) {
          return errorText ?? FormBuilderLocalizations.of(context).maxErrorText(max);
        }
      }
      return null;
    };
  ...
  static FormFieldValidator<String> minLength(
    ...
    return (valueCandidate) {
      ...
      return valueLength < minLength && (!allowEmpty || valueLength > 0)
          ? errorText ?? FormBuilderLocalizations.of(context).minLengthErrorText(minLength)
          : null;
    };
  }
  ...
  static FormFieldValidator<String> maxLength(
    ...
    return (valueCandidate) => null != valueCandidate && valueCandidate.length > maxLength
        ? errorText ?? FormBuilderLocalizations.of(context).maxLengthErrorText(maxLength)
        : null;
  }
  //
  ...
  // }) =>
  //     (valueCandidate) =>
  //         true == valueCandidate?.isNotEmpty && !isIP(valueCandidate, version) ? errorText ?? FormBuilderLocalizations.of(context).ipErrorText : null;
